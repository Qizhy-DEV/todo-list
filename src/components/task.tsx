...
const Task = ({task, changeTask, removeTask} : {task : TaskInterface, changeTask: (task: TaskInterface) => void, removeTask: (task: TaskInterface) => void}) => {

    return (
        <div className="task">
            <div className='task__top-area'>
                <div className='task__top-area__content'>
                    <span className={`task__top-area__content__title ${task.isCompleted && 'task__top-area__content__title--completed'}`}>
                        {task.title}
                    </span>
                    <span className={`task__top-area__content__subtitle ${task.isCompleted && 'task__top-area__content__subtitle--completed'}`}>
                        {task.subtitle}
                    </span>
                </div>
                <button 
            ...
            <div className='task__bottom-area'>
                ...
                <button 
                    ...
                    className='task__bottom-area__btn-remove'>
